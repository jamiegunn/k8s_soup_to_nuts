...
| ↳ [Longhorn Under Valkey: Storage Internals Deep Dive](/architectures/valkey-longhorn-deep-dive/) | What's *under* the PVC — the iSCSI data path, CSI/CRD control plane, Linux and CNI dependencies, StorageClass knobs, Prometheus metrics, and the break-it-on-purpose drills |
...
| To understand and tune the storage under Valkey | [Longhorn Under Valkey](/architectures/valkey-longhorn-deep-dive/) | The iSCSI/CSI internals, StorageClass knobs, observability, and failure drills beneath a Valkey PVC on Longhorn |
