...
And the lab after this one asks the question autoscaling can't: the HPA decides how many pods you have; [Lab 11](/labs/lab-11-survive-the-drain/) decides how many may be *missing* — evictions, disruption budgets, and the drain that arrives at 3 a.m. when the HPA has scaled you to the floor.
