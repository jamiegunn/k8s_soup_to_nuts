...
3. [The Three Doors](/start/three-doors/) — the model for thinking about *any* workload: cost (requests/limits), lifecycle (health checks and shutdown), and response (scaling) as one loop. The rest of this track is you walking through these three doors.
